...
| format       | No       | Discord sends plain text by default. Set this to `markdown` when you want Apprise to use Discord embeds for a richer layout.                                                                                                                                                                                                                                                                                                    |
...
Send multiple attachments in a single Discord message (default behaviour):
...
Send multiple attachments one per message (legacy behaviour):
