...
| Library Evicted | Services Freed From                   | Savings  |
| :-------------- | :------------------------------------ | :------: |
| `slixmpp`       | `xmpp://`                             |  ~20 MB  |
| `paho`          | `mqtt://`                             |  ~4 MB   |
| `gntp`          | `growl://`                            |  ~2 MB   |
...
†`cryptography` wraps OpenSSL natively. Python wrapper objects are freed; the native shared library remains mapped at the OS level.
