...
Browser logins have their own built-in signing key. Changing `APPRISE_WEB_AUTH_SECRET` signs out every browser but does not change hash-mode configuration paths.
