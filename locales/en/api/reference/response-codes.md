...
| `403` | Forbidden                       | The server setting or current access level denies the request. Examples include disabled stateful storage, an unavailable `/cfg` list, or locked configuration content.                                                                                              |
