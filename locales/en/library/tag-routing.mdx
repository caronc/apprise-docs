...
levels without success, Apprise stops with a failed result without running further rounds
...
exhausts all its priority levels without success, Apprise returns a failed result without
