...
- [**Email (PGP)**](https://github.com/caronc/apprise/blob/master/apprise/plugins/email/base.py): Stores a sender key pair generated by an encrypted self-send so later runs reuse the same identity. External recipient keys are never generated.
