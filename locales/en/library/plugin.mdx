...
| `notify_format`                     | `text`     | Default message format(s); a single value or a tuple.      | If your service is Markdown or HTML-first, or natively renders more than one format. |
...
| `setup_url`   | Links to the Apprise-specific integration guide on `appriseit.com` (e.g. `https://appriseit.com/services/discord/`). Shown as "Setup guide". |
