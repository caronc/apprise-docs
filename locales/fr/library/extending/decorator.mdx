...
Par défaut, votre fonction reçoit le corps **exactement tel que l'appelant l'a
envoyé**. Pour demander à Apprise de le convertir d'abord, ajoutez
`body_format=` à `@notify()` :
