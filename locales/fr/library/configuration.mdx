...
Lors de l'envoi via la bibliotheque Python, `notify(tag=...)` suit les regles suivantes :
...
:::note
Les listes sont evaluees comme des groupes **OU**. Pour exprimer un **ET**
de maniere programmatique, utilisez une chaine separee par des virgules dans
l'argument `tag`.
:::
