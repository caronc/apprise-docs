...
description: Envoyer files, in-memory content, and hosted URLs through Apprise services that support attachments.
sidebar:
  order: 7
---
...
| `INACCESSIBLE` | Pieces jointes are disabled entirely. All downloads fail and attachments evaluate to `False`. |
...
## Working with Pieces jointes in Plugins
...
## Practical Exemples in Core Plugins
