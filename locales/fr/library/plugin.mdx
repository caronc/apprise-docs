...
| `notify_format`                     | `text`     | Format(s) de message par défaut ; une seule valeur ou un tuple.                             | Si votre service privilégie Markdown ou HTML, ou rend nativement plusieurs formats. |
