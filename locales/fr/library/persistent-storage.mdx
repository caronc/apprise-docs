...
- [**Email (PGP)**](https://github.com/caronc/apprise/blob/master/apprise/plugins/email/base.py) : stocke la paire de clés de l'expéditeur générée lors d'un auto-envoi chiffré afin que les exécutions suivantes réutilisent la même identité. Les clés des destinataires externes ne sont jamais générées.
