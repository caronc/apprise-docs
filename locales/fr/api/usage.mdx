...
1. **Stateless :** vous fournissez les URL de configuration dans la charge utile de la requête.
1. **Stateful :** vous référencez une clé de configuration préalablement enregistrée.
