...
| `APPRISE_TEMPLATE_<NOM>`                | Fournir une valeur pour un `${NOM}` utilisé par une configuration YAML. Par exemple, `APPRISE_TEMPLATE_API_KEY` remplit `${API_KEY}`. Voir [Variables de substitution](/getting-started/configuration/#variables-de-substitution).                                                                                           |
