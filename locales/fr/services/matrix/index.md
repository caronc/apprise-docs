...
description: "Envoyer Matrix notifications."
sidebar:
  label: "Matrix"
...
Envoyer une secure Matrix notification using a username and password:
...
Envoyer une notification using a pre-generated access token (useful when
...
Envoyer une direct message to a Matrix user:
...
Envoyer une direct message using a pre-generated access token:
...
Envoyer une **t2bot.io** webhook request:
...
Envoyer une **matrix-hookshot** webhook request:
