...
description: "Envoyer Mattermost notifications."
sidebar:
  label: "Mattermost"
...
Envoyer une secure Mattermost notification to our server using a webhook:
...
Envoyer une secure Mattermost notification to our server running on TCP Port 8065:
...
Envoyer an insecure Mattermost notification to a server, addressing specific
channels:
...
Envoyer une webhook notification with a custom display name (botname):
...
Envoyer une bot message with a file attachment:
