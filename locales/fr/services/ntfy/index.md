...
- **private** : un serveur prive heberge localement [https://github.com/binwiederhier/ntfy](https://github.com/binwiederhier/ntfy)
- **cloud** : une configuration pointant vers [https://ntfy.sh](https://ntfy.sh)
