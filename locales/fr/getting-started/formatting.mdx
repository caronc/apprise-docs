...
Vous pouvez placer l'URL de configuration de votre API Apprise dans l'un des emplacements par défaut utilisés par la CLI Apprise. Un serveur avec `APPRISE_CONFIG_LOCK=yes` exige les identifiants de l'administrateur global :
